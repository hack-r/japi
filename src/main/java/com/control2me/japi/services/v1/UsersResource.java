...
public class UsersResource {
	...
	notes="This API retreices the public information for the user (Private info is returned if this is the auth user)"
	...
	public Response getUserById(@ApiParam(value="userId",required=true, defaultValue = "23456", allowableValues="",allowMultiple=false)
		...
		if(userId == null){
			return Response.status(Response.Status.BAD_REQUEST)
					.entity("{\"error\":\"Not Authorized. Empty userId\"}")
					.build();
		}
